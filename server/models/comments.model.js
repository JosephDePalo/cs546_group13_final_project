...
commentSchema.statics.getCommentReplies = function (
  ...
  return this.find({
    ...
    .populate("user_id", "username first_name last_name profile_picture_url")
    .sort({ createdAt: 1 }) // Replies are arranged in ascending order of time.
    .skip((page - 1) * limit)
    .limit(limit);
};
